...
do
	function library:Window(windowInfo)
		...
		local accentFirst = utility:Create({Type = "Frame", Properties = {
			BackgroundColor3 = Color3.fromRGB(117,17,17),
			BorderSizePixel = 0,
			Parent = accent,
			Position = UDim2.new(0, 0, 0, 0),
		...
		local accentSecond = utility:Create({Type = "Frame", Properties = {
			BackgroundColor3 = Color3.fromRGB(74,10,10),
			BorderSizePixel = 0,
			Parent = accent,
		...
		local pagesHolder = utility:Create({Type = "Frame", Properties = {
			BackgroundColor3 = Color3.fromRGB(91,41,41),
			BorderColor3 = Color3.fromRGB(40,17,17),
			BorderMode = "Inset",
			BorderSizePixel = 1,
			Parent = frame,
		...
		function window:Page(pageInfo)
			...
			local tabInline = utility:Create({Type = "Frame", Properties = {
				BackgroundColor3 = Color3.fromRGB(67,10,10),
				BorderSizePixel = 0,
				Parent = tab,
				Position = UDim2.new(0, 1, 0, 1),
			...
			local tabGradient = utility:Create({Type = "UIGradient", Properties = {
				Color = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.fromRGB(54, 54, 54)), ColorSequenceKeypoint.new(1, Color3.fromRGB(100, 100, 100))}),
				Rotation = 60,
			...
			function page:Turn(state)
				tabTitle.TextColor3 = state and Color3.fromRGB(249,47,47) or Color3.fromRGB(183,33,33)
			...
			function page:Section(sectionInfo)
				...
				local sectionMain = utility:Create({Type = "Frame", Properties = {
					BackgroundColor3 = Color3.fromRGB(61,27,27),
				...
				local sectionTitle = utility:Create({Type = "TextLabel", Properties = {
					...
					BorderSizePixel = 0,
					Parent = sectionMain,
					Position = UDim2.new(0, 11, 0.01, 0),
					Size = UDim2.new(1, -29, -555, 455),
					Font = "Michroma",
					RichText = true,
				...
				local sectionTitleLine = utility:Create({Type = "Frame", Properties = {
					BackgroundColor3 = Color3.fromRGB(26,10,10),
					BorderSizePixel = 0,
					Parent = sectionMain,
				...
				local sectionScrollingBar = utility:Create({Type = "Frame", Properties = {
					AnchorPoint = Vector2.new(1, 0),
					BackgroundColor3 = Color3.fromRGB(41,23,23),
					BorderSizePixel = 0,
				...
				local sectionInline = utility:Create({Type = "Frame", Properties = {
					BackgroundColor3 = Color3.fromRGB(36,15,15),
					BorderSizePixel = 0,
					Parent = sectionContentHolder,
					Position = UDim2.new(0, 1, 0, 1),
				...
				function section:Toggle(toggleInfo)
					...
					local toggleInlineGradient = utility:Create({Type = "Frame", Properties = {
						BackgroundColor3 = toggle.state and Color3.fromRGB(236,85,85) or Color3.fromRGB(236,85,85),
						BorderSizePixel = 0,
						Parent = toggleFrame,
						Position = UDim2.new(0, 1, 0, 1),
						Size = UDim2.new(1, -2, 1, -2)
				...
				function section:Button(buttonInfo)
					...
					local buttonInline = utility:Create({Type = "Frame", Properties = {
						BackgroundColor3 = Color3.fromRGB(21,15,15),
						BorderSizePixel = 0,
						Parent = buttonFrame,
						Position = UDim2.new(0, 1, 0, 1),
						Size = UDim2.new(1, -2, 1, -2)
				...
				function section:Slider(sliderInfo)
					...
					local sliderGradient = utility:Create({Type = "UIGradient", Properties = {
						Color = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.fromRGB(171,0,0)), ColorSequenceKeypoint.new(1, Color3.fromRGB(91,41,41))}),
						Rotation = 40,
